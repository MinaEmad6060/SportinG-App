...
class LeagueDetailsViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.register(nibCustomCell, forCellWithReuseIdentifier: "Cell")
        self.collectionView.register(nibCustomCell, forCellWithReuseIdentifier: "thirdCell")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section==0 {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as? LeagueDetailsCollectionViewCell else { fatalError("Failed to dequeue NewsCell") }
            ...
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "thirdCell", for: indexPath) as? LeagueDetailsCollectionViewCell else { fatalError("Failed to dequeue NewsCell") }
            ...
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "secondCell", for: indexPath) as? LogoCollectionViewCell else { fatalError("Failed to dequeue NewsCell") }
            ...
            if(teamsResults.count != 0){
                   ...
                   let teamUrl = URL(string: teamLogoUrl)
                {
                    ...
                    cell.teamLogo.image = UIImage(named: "man.png")
                }
            }
